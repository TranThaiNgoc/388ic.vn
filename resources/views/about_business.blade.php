                ...
                <div class="d-md-inline-block text-md-left text-center text-primary title-content">
                    <div class="be-text-large d-md-inline-block d-block">
                        <ul class="nolist be-breadcrumb text-uppercase d-inline-flex">
                            ...
                            <li><span>@lang('home.business_areas')</span></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<section>
    <div class="container">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-md-9 py-3 py-md-0">
                        {!! isset($business->content) ? $business->content : '' !!}
                    </div>
                    <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-12 py-3">
                <h1 class="header-title text-md-left text-uppercase text-center text-md-left">
                    {{ isset($business->name_en) ? $business->name_en : '' }}
                </h1>
                <hr>
            </div>
            <div class="col-12">
                <div class="row">
                    <div class="col-md-9 py-3 py-md-0">
                        {!! isset($business->content_en) ? $business->content_en : '' !!}
                    </div>
                    <div class="col-md-3">
                        <div class="d-block text-center">
