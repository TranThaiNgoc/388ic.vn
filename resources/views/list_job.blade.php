                ...
                <div class="d-md-inline-block text-md-left text-center text-primary title-content">
                    <div class="be-text-large d-md-inline-block d-block">
                        <ul class="nolist be-breadcrumb text-uppercase d-inline-block">
                            ...
                            <li><span>@lang('home.job_menu')</span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 py-3">
                <h1 class="header-title text-md-left text-uppercase">@lang('home.job_menu')</h1>
                <hr>
            </div>
                    ...
                    <div class="col-md-9">
                        <ul class="nolist">
                            ...
                            <li class="recruit-items__hover mb-3">
                                <div class="row align-items-center">
                                    <div class="col-md-4 col-4">
                                        <a href="{{ route('job',['slug'=>$value->slug]) }}"><img src="{{ $value->image }}" alt="{{ $value->title_en }}"></a>
                                    </div>
                                    <div class="col-md-8 col-8">
                                        <div class="recruit-title">
                                            <a href="{{ route('job',['slug'=>$value->slug]) }}">{{ $value->title_en }}</a>
                                        </div>
                                        <div class="recruit-content">
                                            <label>
                                                <i class="fa fa-money" aria-hidden="true"></i>
